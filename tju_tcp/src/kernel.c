...
void startSimulation(){
    ...
    /*if(strcmp(hostname,"server")==0){
        conn.sin_port = htons((unsigned short)5678);
    }else if(strcmp(hostname,"client")==0){
        conn.sin_port = htons((unsigned short)1234);
    }
    */
